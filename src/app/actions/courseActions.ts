...
export class CourseActions {
    ...
    updateCourse(course: ICourse): ActionWithPayload<ICourse> {
        return {
            type: CourseActions.UPDATE, 
            payload: course
        };
    }

    static readonly UPDATE_SUCCESS = 'UPDATE_SUCCESS';
    updateCourseSuccess(course: ICourse): ActionWithPayload<ICourse> {
        return {
            type: CourseActions.UPDATE_SUCCESS, 
            payload: course
        };
    }
